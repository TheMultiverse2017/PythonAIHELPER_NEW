...
class TikTok:
    ...
    def __init__(self,tiktok_sessionid: str, tiktok_voice: str):
        self.tiktok_sessionid = tiktok_sessionid
        self.tiktok_voice = tiktok_voice
        headers = {
            "User-Agent": "com.zhiliaoapp.musically/2022600030 (Linux; U; Android 7.1.2; es_ES; SM-G988N; "
            "Build/NRD90M;tt-ok/3.12.13.1)",
            "Cookie": f"sessionid={self.tiktok_sessionid}",
        }
