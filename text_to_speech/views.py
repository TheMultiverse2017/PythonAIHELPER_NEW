...
def texttovoiceConvert(request):
    ...
    if request.method == 'POST':
        ...
        message = texToSpeechOnSelect(text, ttsselected, tiktok_voice, voice, vol, rate)

    return render(request,'texttovoice/home.html',{'title':title, 'message':message})
    # return render(request,'texttovoice/home.html',{'title':title, 'message': message})

def texToSpeechOnSelect(text = '', ttsselected = '', tiktok_voice = 'en_us_001', voice = 1, vol = 1.5, rate = 125 ):
